...
class AppDelegate: UIResponder, UIApplicationDelegate
{
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool
    {
        ...
        */
        ...
        if !exists
        {
            let fakeDate1 = String(NSDate(timeIntervalSinceReferenceDate: 491090000))
            let fakeDate2 = String(NSDate(timeIntervalSinceReferenceDate: 491600000))
            let fakeDate3 = String(NSDate(timeIntervalSinceReferenceDate: 492000100))
            let fakeDate4 = String(NSDate(timeIntervalSinceReferenceDate: 492300000))
            let fakeDate5 = String(NSDate(timeIntervalSinceReferenceDate: 493030000))
            let fakeDate6 = String(NSDate(timeIntervalSinceReferenceDate: 493516800))
            ...
            let data1 = data.dataUsingEncoding(NSUTF8StringEncoding)!
            data1.writeToURL(path, atomically: true)
        }
